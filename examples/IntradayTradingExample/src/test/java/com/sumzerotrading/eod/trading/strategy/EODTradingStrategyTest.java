...
import com.sumzerotrading.intraday.trading.strategy.IReportGenerator;
import com.sumzerotrading.intraday.trading.strategy.IntradayTradingStrategy;
...
public class EODTradingStrategyTest {
    ...
    public void testGetOrderSize() {
        strategy.start(propFile);
        strategy.previousCloseMap.put(longTicker, 50.00);
        int expectedSize = 20;
    ...
    public void testSetAllPricesInitialized() {
        ...
        strategy.previousCloseMap = mockLastPriceMap;
        strategy.longShortPairMap.put(longTicker, shortTicker);
