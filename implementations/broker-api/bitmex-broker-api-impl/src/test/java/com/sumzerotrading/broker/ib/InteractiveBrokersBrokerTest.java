...
import com.sumzerotrading.broker.bitmex.BitmexBroker;
import com.sumzerotrading.broker.bitmex.OrderManagmentUtil;
...
public class InteractiveBrokersBrokerTest {
    ...
    public void setUp() {
        ...
        BitmexBroker.logger = mockLogger;
        broker  = new BitmexBroker(mockIbSocket);
    ...
    public void testConstructor() {
        try {
            BitmexBroker broker = new BitmexBroker(mockIbSocket);
    ...
    public void testOrderStatus_NonCompletedOrder() throws Exception  {
        BitmexBroker b = spy(BitmexBroker.class);
